...
const ScreenExp = ({ rotate, url, image }: ScreenExpProps) => {
  return (
    <Card
      className={`border-5 p-0 gap-0 m-0 border-(--main-color) md:w-250 md:h-150 rounded-[33px] md:drop-shadow-[40px_40px_0px_rgba(115,20,20,0.47)] ${rotate} group relative `}
